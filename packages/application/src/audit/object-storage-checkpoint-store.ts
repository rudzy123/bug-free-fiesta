...
export function auditCheckpointObjectKey(
 ...
 * operators must enable object-lock/legal hold on a separately controlled bucket.
 * A privileged database administrator who can also replace this store can still
 * rewrite history.
 */
