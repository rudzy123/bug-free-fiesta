...
function replayCreateResponse(
  ...
  return {
    ...
    signingMode: (body.signingMode as CreateDraftDocumentResult['signingMode']) ?? 'ordered',
    ...
    signers: (body.signers as CreateDraftDocumentResult['signers']) ?? [],
    fields: (body.fields as CreateDraftDocumentResult['fields']) ?? [],
    upload: {
