...
| C2  | Separate account-user and signer authentication                                 | [ADR-0009](../architecture/adrs/0009-authentication-boundaries.md), [authentication setup](authentication-setup.md)                                                                                                          |
...
| C6  | Untrusted PDF handling, size limits, structural inspection, no outbound fetches | Worker + `DOCUMENT_INSPECTOR=structural` (production); local stub non-production only                                                                                                                                        |
...
| C13 | Private object storage; content-addressed artifact keys                         | [ADR-0004](../architecture/adrs/0004-private-object-storage.md), [ADR-0010](../architecture/adrs/0010-content-addressed-finalized-artifacts.md), `@esign/object-storage` (`s3` driver; production refuses memory/filesystem) |
